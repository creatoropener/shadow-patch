...
| Node 20 + pinned TypeScript + pinned tsx + node:test (v0.6) | Release candidate | Conventional package root with `package.json`, `tsconfig.json`, locked dependencies, generated-test unused-binding lint, project-aware type checking and a passing repository baseline |
