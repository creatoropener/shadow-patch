...
**Engine: v0.6.0-rc.9 · Recorded verification evidence: v0.5.5 · Track: Coding and Agentic Engineering**
...
```bash
python3 tools/export_target.py --output ../patchproof-target-v0.6.0-rc.9.zip
```
